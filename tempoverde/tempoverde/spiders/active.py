...
class ActiveSpider(scrapy.Spider):
    ...
    start_urls = [
        ...
        'https://www.active-srl.com/it/catalogo/accessori/testine-decespugliatori-batti-e-vai',
        'https://www.active-srl.com/it/catalogo/power-track',
        ]
    ...
    def parse(self, response):
        print(response)
        for link in response.css('a.see-details-hover::attr(href)'):
